...
RSpec.describe StartupsController, type: :controller do
  ...
  describe "GET #index" do
    it "returns a success response" do
      Startup.create! valid_attributes
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: startup.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      startup = Startup.create! valid_attributes
      get :edit, params: {id: startup.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Startup" do
        expect {
          post :create, params: {startup: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {startup: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
